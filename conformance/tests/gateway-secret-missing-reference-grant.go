...
var GatewaySecretMissingReferenceGrant = suite.ConformanceTest{
	...
	Description: "A Gateway in the gw-conf-infra namespace should fail to become programmed if the Gateway has a certificateRef for a Secret in the gateway-conformance-web-backend namespace and a ReferenceGrant granting permission to the Secret does not exist",
	...
	Test: func(t *testing.T, s *suite.ConformanceTestSuite) {
		gwNN := types.NamespacedName{Name: "gateway-secret-missing-reference-grant", Namespace: "gw-conf-infra"}

...
var GatewaySecretReferenceGrantAllInNamespace = suite.ConformanceTest{
	...
	Description: "A Gateway in the gw-conf-infra namespace should become programmed if the Gateway has a certificateRef for a Secret in the gateway-conformance-web-backend namespace and a ReferenceGrant granting permission to all Secrets in the namespace exists",
	...
	Test: func(t *testing.T, s *suite.ConformanceTestSuite) {
		gwNN := types.NamespacedName{Name: "gateway-secret-reference-grant-all-in-namespace", Namespace: "gw-conf-infra"}

...
var GatewaySecretInvalidReferenceGrant = suite.ConformanceTest{
	...
	Description: "A Gateway in the gw-conf-infra namespace should fail to become ready if the Gateway has a certificateRef for a Secret in the gateway-conformance-web-backend namespace and a ReferenceGrant exists but does not grant permission to that specific Secret",
	...
	Test: func(t *testing.T, s *suite.ConformanceTestSuite) {
		gwNN := types.NamespacedName{Name: "gateway-secret-invalid-reference-grant", Namespace: "gw-conf-infra"}
